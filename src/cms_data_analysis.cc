...
class cms_data_alaysis: public edm::EDAnalyzer {
public:
        explicit cms_data_alaysis(const edm::ParameterSet&);
        ~cms_data_alaysis();
...
cmsdata::cms_data_alaysis(const edm::ParameterSet& iConfig) {
...
cms_data_alaysis::~cms_data_alaysis() {
...
void cms_data_alaysis::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
...
void cms_data_alaysis::beginJob() {

}

// ------------ method called once each job just after ending the event loop  ------------
void cms_data_alaysis::endJob() {
}
