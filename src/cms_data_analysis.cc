// -*- C++ -*-
//
// Package:    cms_data_analysis
// Class:      cms_data_analysis
//
/**\class cms_data_analysis cms_data_analysis.cc Demo/cms_data_analysis/src/cms_data_analysis.cc
...
class cms_data_analysis: public edm::EDAnalyzer {
public:
        explicit cms_data_analysis(const edm::ParameterSet&);
        ~cms_data_analysis();
...
cms_data_analysis::cms_data_analysis(const edm::ParameterSet& iConfig) {
...
cms_data_analysis::~cms_data_analysis() {
...
void cms_data_analysis::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
...
} //cms_data_analysis: analyze ends


// ------------ method called once each job just before starting event loop  ------------
void cms_data_analysis::beginJob() {

}

// ------------ method called once each job just after ending the event loop  ------------
void cms_data_analysis::endJob() {
}

//define this as a plug-in
DEFINE_FWK_MODULE(cms_data_analysis);                                                                            
